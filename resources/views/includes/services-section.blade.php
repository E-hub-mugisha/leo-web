...
<section class="position-relative gray">
    <div class="container">
        ...
        <div class="row g-xl-4 g-lg-3 g-3">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">Agent Network Accelerator</h4>
                            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">ANM, Agent Network Management</h4>
                            </div>
                            <div class="article-desc mb-3">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">Community Agent Network</h4>
                            </div>
                            <div class="article-desc mb-3">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">Market activation</h4>
                            </div>
                            <div class="article-desc mb-3">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">Product Distribution</h4>
                            </div>
                            <div class="article-desc mb-3">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="verticle-blog-wrap bg-white p-2 rounded-2 wow animated fadeInUp">
                    <div class="row align-items-start">
                        <div class="article-caption py-2">
                            <div class="article-heads mb-3">
                                <h4 class="font--bold mb-1">Liquidity & Float Management</h4>
                            </div>
                            <div class="article-desc mb-3">
