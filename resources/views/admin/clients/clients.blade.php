        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i class="fa fa-plus"></i> Add Partner</a>
            ...
            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div class="profile-widget">
                    <div class="profile-img">
                        <a href="client-profile.html" class="avatar"><img alt="" src="{{ asset('image/partners')}}/{{ $partner->image }}"></a>
                    </div>
                    ...
                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.html">{{ $partner->names }}</a></h4>
                    <div class="small text-muted">{{ $partner->description }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Names<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="names" id="names">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Image Logo</label>
