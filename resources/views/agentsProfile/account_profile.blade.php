                    ...
                    <div class="offcanvas-body pt-0 pe-lg-4">
                        <div class="position-relative px-lg-4 py-lg-5 rounded-4 bg-white">
                            ...
                            <div class="user-prfl text-center mx-auto">
                                ...
                                <div class="user-caps">
                                    <h5 class="mb-0">{{$agent->names}}</h5>
                                    <p class="m-0 text-muted">{{$agent->businessNames}}, {{$agent->businessCategory}}</p>
                                </div>
                            </div>

                            <div class="user-prfl-nav mt-4">
                                <ul class="no-ul-list">
                                    <li class="py-3"><a href="account-dashboard.html" class="fw-medium"><i class="fa-solid fa-gauge-high me-2"></i>User Dashboard</a></li>
                                    <li class="py-3"><a href="account-profile.html" class="fw-medium active text-primary"><i class="fa-solid fa-id-card me-2"></i>User Profile</a></li>
                                    <li class="py-3"><a href="account-billing.html" class="fw-medium"><i class="fa-solid fa-wallet me-2"></i>Billing</a></li>
                                    <li class="py-3"><a href="account-order.html" class="fw-medium"><i class="fa-solid fa-basket-shopping me-2"></i>My Order</a></li>
                                    <li class="py-3"><a href="account-setting.html" class="fw-medium"><i class="fa-solid fa-gear me-2"></i>Settings</a></li>
                                    <li class="py-3 pb-0"><a href="account-notifications.html" class="fw-medium"><i class="fa-regular fa-bell me-2"></i>Notifications</a></li>
                                </ul>
                            </div>
                ...
                <div class="dash-wrapsw card py-0 px-lg-5 px-4 pb-4 border-0 rounded-4 mb-4">
                    ...
                    <div class="dash-y44 position-relative mb-5">
                        <div class="dash-user-thumb mt-5 pt-2">
                            <img src="assets/img/team-1.jpg" class="img-fluid circle border border-3" width="100" alt="User">
                        </div>
